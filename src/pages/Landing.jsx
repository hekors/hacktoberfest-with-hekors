        ...
        <section className="landing-page-container">
            ...
            >
                ...
                <div className="rsvp-content-wrapper flex flex-col items-center justify-center">
                    <h1 className="leading-snug text-lg text-gray-800 font-semibold">RSVP for the upcoming session today</h1>
                    <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSch0KTa5s2BOUKzZk1wxNLd9JSeIhaYXQGJ0ZHOKGIhW_Zgvw/viewform?embedded=true" width="640" height="2041" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
                </div>
            </ReactModal>
        </section>
    )
